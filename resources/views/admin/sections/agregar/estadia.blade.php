    ...
    <div class="col-md-12 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.estadias.store') }}" method="POST" enctype="multipart/form-data" id="formulario-estadia">
            @csrf
            @method('POST')
            <!-- Fecha Inicio -->
            <div class="mb-3">
              <label for="fechaInicio_estadia" class="form-label">Fecha de inicio</label>
              <input type="date" class="form-control" id="fechaInicio_estadia" name="Fecha_Inicio" required>
            ...
            <div class="mb-3">
              ...
              <input type="date" class="form-control" id="fechaFin_estadia" name="Fecha_Fin" required>
              <div class="valid-feedback d-none">Fecha válida.</div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control" id="costo_estadia" name="Costo" required>
              </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" name="Habitacion_idHabitacion" id="id_habitacion_estadia" class="form-control" required>
